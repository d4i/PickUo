			...
			<div class='modal-dialog modal-sm' role='document'>
				<div class='modal-content'>
					<div class="modal-header">
						...
						<h4 class='model-title'>SignUp with different account</h4>
						<button class='btn btn-success' data-toggle='modal' data-target='#signupModal'>Sign Up</button><br />
						<h5>Or <br/><br/>
						<button class='btn btn-success' id='userlogoutbtn' onclick='user_logout.do'>Logout</button></h5>
					</div>
		  ...
		  <div class="modal-body">
			<form action='user_signup.do' id='signup_form' method='post'>
				...
				<div class='form-group'>
					...
					<input type='button' class='btn btn-default btn-lg form-control' id='dob' value='Select date' name='dob'>
				</div>
